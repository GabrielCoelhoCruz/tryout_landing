        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-6 gap-4">
            {steps.map((step, index) => (
              ...
              >
                {/* Icon circle */}
                <div className="relative z-10 w-16 h-16 rounded-full bg-gradient-to-br from-primary to-royal-light flex items-center justify-center text-3xl mb-4 shadow-lg shadow-primary/30 border-4 border-dark">
                  {step.icon}
                </div>
